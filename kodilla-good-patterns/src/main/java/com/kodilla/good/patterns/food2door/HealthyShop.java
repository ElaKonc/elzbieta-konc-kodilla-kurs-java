...
public class HealthyShop implements Producer {
    ...
    private Map<Product, Integer> createProductList() {
        ...
        productsList.put(new ProductGlutenFree("makaron ryżowy", "250 g","bez glutenu"), 5);
        productsList.put(new ProductJuice("sok z aloesu", "500 ml","sok"), 20);
        productsList.put(new ProductDairy("jajka", "ekologiczne, 6 szt.","nabiał"), 0);
        productsList.put(new ProductMeat("pierś", "","indyk"), 5);
